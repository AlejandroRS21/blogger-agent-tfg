...
- [x] T007 [US1] Create a functional component `frontend/app/components/PostCard.tsx` strictly rendering basic post information (title, excerpt, date string) leveraging the defined TS interfaces.
...
**Source**: Post-implementation cleanup of 004-next-vercel-frontend
