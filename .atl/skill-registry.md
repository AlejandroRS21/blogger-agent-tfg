# Skill Registry — blogger-agent-tfg
...
### branch-pr
- Path: /home/arami/.config/opencode/skills/branch-pr/SKILL.md
...
### cavecrew
- Path: /home/arami/Escritorio/PROYECTOS/Big Data IA/Modelos de IA/blogger-agent-tfg/.agents/skills/cavecrew/SKILL.md
- Trigger: >
- Rules:
...
### caveman
- Path: /home/arami/Escritorio/PROYECTOS/Big Data IA/Modelos de IA/blogger-agent-tfg/.agents/skills/caveman/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-commit
- Path: /home/arami/Escritorio/PROYECTOS/Big Data IA/Modelos de IA/blogger-agent-tfg/.agents/skills/caveman-commit/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-compress
- Path: /home/arami/Escritorio/PROYECTOS/Big Data IA/Modelos de IA/blogger-agent-tfg/.agents/skills/caveman-compress/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-help
- Path: /home/arami/Escritorio/PROYECTOS/Big Data IA/Modelos de IA/blogger-agent-tfg/.agents/skills/caveman-help/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-review
- Path: /home/arami/Escritorio/PROYECTOS/Big Data IA/Modelos de IA/blogger-agent-tfg/.agents/skills/caveman-review/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-stats
- Path: /home/arami/Escritorio/PROYECTOS/Big Data IA/Modelos de IA/blogger-agent-tfg/.agents/skills/caveman-stats/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### chained-pr
- Path: /home/arami/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/arami/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/arami/.config/opencode/skills/comment-writer/SKILL.md
...
### find-skills
- Path: /home/arami/.agents/skills/find-skills/SKILL.md
...
### get-api-docs
- Path: /home/arami/.copilot/skills/contex-hub/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: /home/arami/.config/opencode/skills/go-testing/SKILL.md
...
### issue-creation
- Path: /home/arami/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/arami/.config/opencode/skills/judgment-day/SKILL.md
...
### skill-creator
- Path: /home/arami/.config/opencode/skills/skill-creator/SKILL.md
...
### work-unit-commits
- Path: /home/arami/.config/opencode/skills/work-unit-commits/SKILL.md
